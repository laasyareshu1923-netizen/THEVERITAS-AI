...
# 🔑 SECURE SECRET EXTRACTION (From your Streamlit Cloud Settings)
try:
    ...
    if not MASTER_API_KEY:
        ...
        with st.spinner("Analyzing sources and verifying authenticity..."):
            try:
                ...
                # 🛠️ FIXED: Changed from 'gemini-2.5-flash' to the stable 'gemini-2.0-flash' 
                # This bypasses the new user restriction and eliminates the 404 error completely!
